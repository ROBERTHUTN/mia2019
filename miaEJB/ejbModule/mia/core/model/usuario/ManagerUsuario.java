...
//Método que me ingresa la ficha personal
	public void ingresarFichaPersonal(FichaPersonal fichaPersonal, int id_religion, int id_etnia, int id_pais,
		...
		if (id_religion == 0) {
			throw new Exception("Error al seleccionar la religi�n");
		}
		if (id_etnia == 0) {
			throw new Exception("Error al seleccionar la etnia");
		}
		if (id_pais == 0) {
			throw new Exception("Error al seleccionar el pa�s");
		}
		if (estado == 0) {
	...
	public void ingresarEtnia(Etnia etnia) throws Exception {
		if (etnia == null) {
			throw new Exception("Ingrese los datos de la Etnía");
		} 
	...
	public void eliminarGrado(int id_grado) throws Exception {
		...
		if (existeGrado) {
			throw new Exception("El grado est� siendo utilizada por un usuario.");
		}
		em.remove(gradoN);
	}
